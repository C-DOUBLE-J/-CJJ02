		...
		<div id="all">
			...
			<div id="bottom">
				...
				<div id="bleft">
					<div id="ltop">
						<div id="lts">
							<img src="${pageContext.request.contextPath}/images/milogo.jpg" /><br />
							<p style="text-align: center;">小米</p>
						</div>
					</div>
					<div id="lbottom">
						<ul>
							...
							<a href="${pageContext.request.contextPath}/admin/advice.jsp" target="myright">
